...
SEARCH_FLAGS+=(
    --set "images.names.openSearch=dx/dx-opensearch"
    --set "images.names.searchMiddleware=dx/dx-search-middleware"
    --set "images.names.fileProcessor=dx/dx-file-processor"
)
